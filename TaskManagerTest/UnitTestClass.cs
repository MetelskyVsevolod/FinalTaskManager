...
namespace TaskManagetUnitTests
{
    ...
    public class UnitTestClass
    {
        ...
        void clearDatabase()
        {
            ...
            foreach (TTask t in DBHandler.Instance.db.TTasks)
                tasks.Add(t);

            DBHandler.Instance.db.TTasks.RemoveRange(tasks);

            List<User> users = new List<User>();

            foreach (User t in DBHandler.Instance.db.Users)
                users.Add(t);

            DBHandler.Instance.db.Users.RemoveRange(users);
